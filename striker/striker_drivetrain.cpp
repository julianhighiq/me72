...
#define SOLENOID 0.99 // for scaling solenoid power input, should always be > 0.5
...
// Create a RoboClaw object for the driving motors
SoftwareSerial serial(10, 11);
RoboClaw roboclaw(&serial, 10000); // Use Serial Communication

// Create a RoboClaw object for the solenoid
...
void setup() {
  ...
  // Serial2.begin(begin_speed); // intialize both serial objects
  // serial.begin(begin_speed);
  roboclaw.begin(begin_speed); // More initialization
  roboclaw2.begin(begin_speed);
